...
class Pomme_Ray(MultiAgentEnv):
    ...
    '''
    def __init__(self, config=pommerman_cfg.ffa_competition_env()):
        '''
        ...
        self.pomme.set_agents(config['agent_list'])
    ...
    def step(self, action_dict):
        ...
        return _featurize(to_dict(obs)), to_dict(rewards), dones, infos
